...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'app_project', (
            ...
            ('part_of', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Project'], null=True, on_delete=models.SET_NULL, blank=True)),
        ))
        db.send_create_signal(u'app', ['Project'])

        # Adding field 'Task.part_of'
        db.add_column(u'app_task', 'part_of',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Project'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Task.part_of'
        db.delete_column(u'app_task', 'part_of_id')
    ...
    models = {
        ...
        u'app.project': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '140'}),
            'part_of': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['app.Project']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        u'app.scheduleitem': {
        ...
        u'app.task': {
            ...
            'duration': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'habit': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '140'}),
            'note': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'part_of': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['app.Project']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
