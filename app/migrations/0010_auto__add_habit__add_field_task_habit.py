...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'app', ['Habit'])

        # Adding field 'Task.habit'
        db.add_column(u'app_task', 'habit',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'app_habit')

        # Deleting field 'Task.habit'
        db.delete_column(u'app_task', 'habit')
