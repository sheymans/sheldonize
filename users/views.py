...
class UserProfileView(LoginRequiredMixin, FormView):
    ...
    def get_initial(self):
        ...
        return {
                ...
                'showdeadlines': userprofile.showdeadlines,
                }
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            user.userprofile.showdeadlines = form.cleaned_data['showdeadlines']
...
class InviteView(FormView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            message = "Hi!\n\n" + self.request.user.username + " (" + str(self.request.user.email) + ")" + \
                    ...
                    "PS: You can always write me at support@sheldonize.com with any questions!"
